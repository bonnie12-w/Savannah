          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold text-foreground">
                About <span className="gold-gradient-text italic">Views Coffee House</span>
              </h1>
            </motion.div>
            ...
            >
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Born from a passion for authentic kenyan cuisine, Views Coffee House brings the rich flavors 
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              {[
                ...
                { icon: Mail, text: "hello@ViewsCoffeeHouse.co.ke" },
                { icon: Instagram, text: "@ViewsCoffeeHouse" },
