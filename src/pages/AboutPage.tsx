          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold text-foreground">
                About <span className="gold-gradient-text italic">chowpatyke</span>
              </h1>
            </motion.div>
            ...
            >
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
                Born from a passion for authentic kenyan cuisine, Chowpaty Restaurants is one of the oldest and most prestigious pure vegetarian restaurant in Kenya. Visit us today!
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              {[
                ...
                { icon: Mail, text: "hello@chowpatyke.co.ke" },
                { icon: Instagram, text: "@chowpatyke" },
